...
// TODO: share icons SVG and Type if icons count increases
interface Props extends SVGProps<SVGSVGElement> {
  size?: number
}

export function PhPuzzlePiece(props: Props) {
  const { size = 24 } = props
