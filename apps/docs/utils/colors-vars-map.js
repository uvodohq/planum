export const colorsMap = [
  {
    color: '--primary-color',
    description: 'Use this to emphasise main ui components',
  },
  {
    color: '--primary-on-secondary-color',
    description:
      'Use this to emphasise main ui components on secondary background color',
  },
  {
  ...
  },
  {
    ...
    description: 'Use this to indicate selected state of primary items',
  },
  {
  ...
  },
  {
    color: '--private-color',
    description:
      'Use when you want to indicate that something is private (board, icons...)',
  },
  {
    color: '--shareable-color',
    description:
      'Use when you want to indicate that something is shareable (board, dashboard...)',
  },
  // borders
  {
...
export const colorsHashMap = colorsMap.reduce((map, current) => {
  const newColorName = current.color.slice(2)
...
export const getElementColor = (colorName, isSelectedPalette = false) => {
  if (contentColorsByName[colorName]) {
    return `var(--color-${contentColorsByName[colorName]}${
